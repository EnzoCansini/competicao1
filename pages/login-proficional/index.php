...
<body>
    ...
    <main class="">
        ...
        <div class="mensagem w-90 md:w-full md:pr-10 justify-self-center justify-items-end pt-5">
        ...
        <div class="inputs grid grid-cols-1 justify-self-center justify-items-center gap-3">
            <form action="<?= ROOT_PATH ?>assets/src/loginUsuario.php" method="POST" class=" justify-self-center justify-items-center">
