    ...
    <main>
        ...
        <div class="card flex flex-col gap-2 px-2 justify-self-center">
            <div class="card bg-white rounded-[10px] flex-col w-90 md:w-150 justify-self-center p-2">
                ...
                <div class="botoes flex w-auto gap-2 mt-8 justify-between">
                    <a href="../p-confirmar-agendamento" class=" flex bg-red-500 w-full rounded-[10px] justify-center pt-2 pb-2">
                        <p class="text-base font-medium">Cancelar atendimento</p>
                    </a>
                </div>
            </div>
        </div>
