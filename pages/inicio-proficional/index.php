...
<body>
    ...
    <main>
        ...
        <div class="card bg-white rounded-[10px] flex-col w-90 md:w-150 justify-self-center p-2">
            ...
            <a href="../p-confirmar-agendamento" class=" flex items-center gap-2 bg-yellow-300 hover:bg-yellow-400 rounded-[10px] justify-center justify-self-end p-2 mt-3">
        ...
        <div class="card bg-white rounded-[10px] flex-col w-90 md:w-150 justify-self-center p-2 mt-4">
            ...
            <a href="../p-proximas-consultas" class=" flex items-center gap-2 bg-sky-500 w-40 rounded-[10px] justify-center justify-self-end p-2 mt-3">
