...
<body>
    ...
    <main>
        ...
        <form action="../atendimento-selecionar/index.php" method="POST">
            ...
            <div class="card bg-white rounded-[10px] flex-col w-90 md:w-150 justify-self-center p-2">
                ...
                <div class="linha flex items-center">
                    <input type="radio" name="escolha" value="Fazer um check-up" class=" h-4 w-4" id="checkup">
                    <label for="checkup" class=" text-center ml-2">Fazer um check-up</label>
                </div>
                <div class="linha flex items-center">
                    <input type="radio" name="escolha" value="Acompanhar um tratamento" class=" h-4 w-4" id="tratamento">
                    <label for="tratamento" class=" text-center ml-2">Acompanhar um tratamento</label>
                </div>
                <div class="linha flex items-center mb-3">
                    <input type="radio" name="escolha" value="Outro" class=" h-4 w-4" id="outro">
                    <label for="outro" class=" text-center ml-2">Outro</label>
                </div>
                <p>Escreva aqui o motivo</p>
                <textarea name="motivo" rows="3" class=" bg-white border-2 border-gray-700 focus:border-black rounded-[10px] w-83 md:w-143 h-25 pl-1 mt-1" placeholder="Escreva aqui"></textarea>
