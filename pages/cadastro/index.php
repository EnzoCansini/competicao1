...
<body>
    ...
    <main class="">
        ...
        <div class="inputs grid grid-cols-1 justify-self-center justify-items-center gap-3">
            <form action="<?= ROOT_PATH ?>assets/src/cadastrarPaciente.php" method="POST" class=" justify-self-center justify-items-center">
                <div id="cadastro1" class="cadastro1 flex flex-col gap-3 w-90 md:w-150 justify-self-center content-center">
                    <p class="text-2xl text-left text-black">Informe seus dados para criar a sua conta</p>
            ...
            <div class="botoes flex w-full gap-4 justify-between">
                <a href="../login" class=" flex bg-yellow-300 w-full rounded-[10px] justify-center pt-2 pb-2">
                    <p class="text-base font-medium">Ja tenho conta</p>
                </a>
                <a href="../cadastro-proficional" class=" flex bg-cyan-400 w-full rounded-[10px] justify-center pt-2 pb-2">
