...
<body>
    ...
    <main>
        ...
        <div class="mensagem  w-90 md:w-150 justify-self-center p-2 justify-items-start pt-5">

    <?php if (isset($mensagem) && isset($cor)) { ?>

        <p class="<?= $cor ?> mt-2 flex items-center gap-2 px-4 py-3 rounded-lg border shadow-sm text-sm font-medium">
            <?= $mensagem ?>
        </p>
    ...
    <?php } ?>
        ...
        <div class="card bg-white rounded-[10px] flex-col w-90 md:w-150 justify-self-center p-2 mt-4">
            ...
            <a href="../atendimento-anteriores" class=" flex items-center gap-2 bg-yellow-300 w-40 rounded-[10px] justify-center justify-self-end pt-2 pb-2 mt-3">
