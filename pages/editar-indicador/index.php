...
<body>
    ...
    <main>
        ...
        <div class="botao w-90 md:w-150 justify-self-center justify-items-end ">
            <a href="../lista-indicadores" class=" flex items-center my-3 gap-3 bg-sky-600 hover:bg-sky-700 w-25 rounded-[10px] justify-center pt-2 pb-2 transition">
        ...
        <div class="div flex flex-col justify-center justify-self-center gap-4">
            ...
            <div class="card bg-white rounded-[10px] flex-col w-90 md:w-150 justify-self-center p-2">
                ...
                <a href="../editar-indicador" class=" flex items-center gap-2 bg-yellow-300 w-40 rounded-[10px] justify-center justify-self-end pt-2 pb-2 md:mt-0 mt-3">
                    <p class="text-base font-medium">Editar</p>
                </a>
            </div>
            <div class="card bg-white rounded-[10px] flex-col w-90 md:w-150 justify-self-center p-2">
                <p class="mb-2">Pressao arterial e temperatura</p>
                <p>Pressao arterial</p>
                <p>Temperatura</p>
                <a href="../editar-indicador" class=" flex items-center gap-2 bg-yellow-300 w-40 rounded-[10px] justify-center justify-self-end pt-2 pb-2 md:mt-0 mt-3">
                    <p class="text-base font-medium">Editar</p>
                </a>
