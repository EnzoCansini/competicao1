...
<body>
    ...
    <main>
        <div class="titulo md:absolute md:mb-2 pt-3 w-90 md:w-150 justify-self-center">
        ...
        <div class="div flex flex-col justify-center justify-self-center gap-4">
            <div class="card bg-white rounded-[10px] flex-col w-90 md:w-150 justify-self-center p-2">
                <p class="mb-1">Atendimento realizado</p>
                <p>Dia: 25/07/2026</p>
                <p>Hora: 15:31</p>
                <p>Responsavel: Dr. Slabouski</p>
            ...
            <a href="../atendimento-anteriores" class=" flex items-center my-3 gap-3 bg-yellow-400 hover:bg-yellow-500 w-25 rounded-[10px] justify-center pt-2 pb-2 transition">
                <p class="text-base font-medium">Salvar</p>
            </a>
        </div>
            </div>
        </div>
