...
<body>
    ...
    <main>
        <div class="titulo pt-3 w-90 md:w-150 justify-self-center">
            <h2>Verifique as consultas e cofirme as que deseja</h2>
        </div>
        ...
        <div class="card flex flex-col gap-2 px-2 justify-self-center">
            <div class="card bg-white rounded-[10px] flex-col w-90 md:w-150 justify-self-center p-2">
                ...
                <a href="../p-detalhes-agendamento/" type="submit" id="submit" class=" flex bg-yellow-300 hover:bg-yellow-400 w-83 md:w-143 rounded-[10px] justify-center pt-2 pb-2 mt-2 transition">
